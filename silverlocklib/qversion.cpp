...
/*!
    ...
    the components are initialized to 0, 0, -1, -1 (resulting in a logical version number of 0.0).
...
QVersion::QVersion(const QString &version, QObject *parent)
    : QObject(parent), m_major(0), m_minor(0), m_build(-1), m_revision(-1)
{
    QVersion version2 = QVersion::parse(version);
    if (version2.isValid())
    {
